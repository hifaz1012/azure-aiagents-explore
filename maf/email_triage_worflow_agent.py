...
from azure.identity import DefaultAzureCredential  # Uses your az CLI login for credentials
...
async def main() -> None:
    ...
    email_path = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "maf", "spam.txt")
